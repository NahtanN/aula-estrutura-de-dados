...
public class GerenciarClienteDAO implements GerenciarListCliente {
    ...
    @Override
    public void cunsultarCliente(String id) {
    ...
    public void removerCliente(String id) {
        ...
        // this.lista.removeIf(cliente -> cliente.getId().equals(id));
